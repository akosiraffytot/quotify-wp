...
check( 'instant checkout degrades to quote span', strpos( $html, '<span class="quotify-field quotify-quote-link" data-quotify-field="quote"' ) !== false, true );
check( 'instant checkout no fluentcart button', strpos( $html, 'quotify-fluentcart-btn' ), false );
